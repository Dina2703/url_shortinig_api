...
function HeroSection() {
  return (
    <section id="hero" className="h-screen md:h-[75svh] mb-16 ">
      <div className="h-full flex flex-col items-start md:justify-between  md:flex-row-reverse lg:pr-16">
        <div
          className="w-full md:w-1/2 h-2/5 md:h-full relative mb-3 md:mb-0 "
          id="heroImg"
        />
